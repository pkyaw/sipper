...
{
    public class SippsAdapter : BaseAdapter<SippModel>
    {
        readonly Activity _context;
        private readonly List<SippModel> _list;

        public SippsAdapter(Activity context)
        {
            _context = context;
            _list = new List<SippModel>();
        }
        ...
        public void FeedData(IEnumerable<SippModel> newData)
        {
