...
namespace SipperDroid
{
	...
	public class DashBorad : Activity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			ListSipp.Add (p1);
			post p2 = new post ();
			p2.description = "Ops, sorry about that. I updated my code, so now It should not give you that error.";
			p2.reply = "0 Reply";
			p2.duration = 0;
			p2.downCount = 0;
			p2.hour = "2 Hour";
			ListSipp.Add (p2);
			post p3 = new post ();
			p3.description = "Ops, sorry about that. I updated my code, so now It should not give you that error.";
			p3.reply = "0 Reply";
			p3.duration = 0;
			p3.downCount = 0;
			p3.hour = "2 Hour";
			ListSipp.Add (p3);
			post p4 = new post ();
			p4.description = "Ops, sorry about that. I updated my code, so now It should not give you that error.";
			p4.reply = "0 Reply";
			p4.duration = 0;
			p4.downCount = 0;
			p4.hour = "2 Hour";
